    ...
    if args.full:
        ...
        lint_scope.extend(
            [
                ...
                "app/output_checkpoints.py",
                "app/unit_preflight.py",
                "tests/test_incremental_output_recovery.py",
                "app/unit_delivery.py",
                "app/exam_unit_delivery.py",
                "app/practice_unit_delivery.py",
                "tests/test_output_checkpoints.py",
                "tests/test_unit_delivery.py",
                "tests/test_exam_unit_delivery.py",
                "app/render_fonts.py",
                "app/render_audit.py",
                "app/render_word.py",
                ...
                "app/dependency_diagnostics.py",
                "app/update_manager.py",
                "scripts/audit_third_party_notices.py",
                ...
                "app/practice_output_contracts.py",
                ...
                "tests/test_practice_output_contracts.py",
                "tests/test_pydantic_shadow.py",
                ...
                "tests/test_dependency_diagnostics.py",
