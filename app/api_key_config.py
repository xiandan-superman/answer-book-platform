...
ALLOWED_API_KEY_NAMES = {
    "CLOUDFLARE_SMART_ROUTER_URL",
    "CLOUDFLARE_SMART_ROUTER_ACCESS_KEY",
    "CLOUDFLARE_AI_GATEWAY_TOKEN",
    "CLOUDFLARE_AI_GATEWAY_ACCOUNT_ID",
    "CLOUDFLARE_AI_GATEWAY_ID",
    "CLOUDFLARE_AI_GATEWAY_LINGSUAN_SLUG",
    "CLOUDFLARE_AI_GATEWAY_WAWAPI_SLUG",
    ...
    "WAWAPI_OPENAI_API_KEY",
    "WAWAPI_GOOGLE_API_KEY",
    "WAWAPI_XAI_API_KEY",
    "WAWAPI_IMAGE_OPENAI_API_KEY",
    "WAWAPI_IMAGE_GOOGLE_API_KEY",
    "WAWAPI_IMAGE_XAI_API_KEY",
}
