...
class PracticeRedesignTests(unittest.TestCase):
    ...
    def test_partial_generation_has_visible_error_cards_and_keeps_export_enabled(self) -> None:
        ...
        self.assertIn('generationErrorTitle', self.js)
        self.assertIn('generationErrorAction', self.js)
        self.assertIn('题 · ${escapeHtml(auditNeedsReview ? "蓝图待复核" : generationErrorTitle)}', self.js)
