...
|---|---|---|---|---|---|---|---|---|---|---|
| Gemini 智能路由 | `gemini-smart-router` | text_generation | text、image → text | 委托实际候选（试运行） | delegated_to_candidate | delegated_to_candidate | 待验证 | 材料理解:limited；考查内容规划:limited；教材证据确认:limited；蓝图规划:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；答案生成:limited；正确性复核:limited；语义审查:limited；格式修复:limited；图片生成:forbidden | C |  |
| GPT 智能路由 | `gpt-smart-router` | text_generation | text、image → text | 委托实际候选（试运行） | delegated_to_candidate | delegated_to_candidate | 待验证 | 材料理解:limited；考查内容规划:limited；教材证据确认:limited；蓝图规划:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；答案生成:limited；正确性复核:limited；语义审查:limited；格式修复:limited；图片生成:forbidden | C |  |
| 生图智能路由 | `image-smart-router` | image_generation | text、image → image | 不适用 | not_applicable | not_applicable | 待验证 | 图片生成:limited | C |  |
| Claude 智能路由 | `claude-smart-router` | text_generation | text、image → text | 委托实际候选（试运行） | delegated_to_candidate | delegated_to_candidate | 待验证 | 材料理解:limited；考查内容规划:limited；教材证据确认:limited；蓝图规划:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；答案生成:limited；正确性复核:limited；语义审查:limited；格式修复:limited；图片生成:forbidden | C |  |
...
| 阿里百炼 | `qwen-image-3.0` | image_generation | text → image | 不适用 | not_applicable | not_applicable | 待验证 | 图片生成:limited | C | unknown |
| 阿里百炼 | `qwen-image-2.0-2026-03-03` | image_generation | text → image | 不适用 | not_applicable | not_applicable | 待验证 | 图片生成:limited | C | unknown |
...
| 灵算 · 国模分组 | `deepseek-v4.1-flash` | text_generation | text、image → text | 已开启（无需探测） | platform_verified_json | supported | 待验证 | 材料理解:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；正确性复核:limited；格式修复:limited | B | 2026-09-16 |
...
| Top-API · Gemini | `gemini-3.8-flash-high` | text_generation | text、image → text | 已开启（无需探测） | unknown | unknown | 待验证 | 材料理解:limited；考查内容规划:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；正确性复核:limited；格式修复:limited | C | unknown |
| Top-API · Gemini | `gemini-3.7-flash-high` | text_generation | text、image → text | 已开启（无需探测） | unknown | unknown | 待验证 | 材料理解:limited；考查内容规划:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；正确性复核:limited；格式修复:limited | C | unknown |
| Top-API · Gemini | `gemini-3.6-flash-high` | text_generation | text、image → text | 已开启（无需探测） | unknown | unknown | 待验证 | 材料理解:limited；考查内容规划:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；正确性复核:limited；格式修复:limited | C | unknown |
| 灵算 · Claude | `claude-opus-5` | text_generation | text、image → text | 已开启（无需探测） | unknown | unknown | 待验证 | 材料理解:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；正确性复核:unknown | C | 2026-09-18 |
| 灵算 · Claude | `claude-sonnet-5` | text_generation | text、image → text | 已开启（无需探测） | unknown | unknown | 待验证 | 材料理解:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；正确性复核:unknown | C | 2026-09-18 |
| WawAPI · Claude | `claude-opus-5` | text_generation | text、image → text | 已开启（无需探测） | unknown | unknown | 待验证 | 材料理解:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；正确性复核:unknown | C | 2026-09-18 |
| WawAPI · Claude | `claude-sonnet-5` | text_generation | text、image → text | 已开启（无需探测） | unknown | unknown | 待验证 | 材料理解:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；正确性复核:unknown | C | 2026-09-18 |
