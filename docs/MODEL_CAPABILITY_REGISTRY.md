...
| 灵算 Google | `gemini-3.7-flash` | text_generation | text、image → text | 未登记/禁用 | unknown | minimum_minimal | 待验证 | 材料理解:limited；蓝图规划:limited；正式生题:limited；答案生成:limited；正确性复核:unknown | C | unknown |
